const singleWords = [
	...
	"conquanto", "continuando", "contudo", "decerto", "embora", "enfim", "enquanto", "então", "entretanto", "eventualmente",
	"igualmente", "inegavelmente", "inesperadamente", "mas", "outrossim", "pois", "porquanto", "porque", "portanto",
	"posteriormente", "precipuamente", "primeiramente", "primordialmente", "principalmente", "salvo", "segundo",
...
const multipleWords = [
	...
	"depois que", "desde que", "dessa forma", "dessa maneira", "desse modo", "desta forma", "desta maneira", "deste modo", "do mesmo modo", "é provável",
	"em conclusão", "em contrapartida", "em contraste com", "em outras palavras", "em primeiro lugar", "em princípio", "em resumo", "em seguida",
	...
	"nesse sentido", "no entanto", "no mais", "no momento em que", "ou por outra", "ou seja", "para que", "para tanto", "pelo contrário", "pois bem", "por analogia",
